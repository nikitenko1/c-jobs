...
export const orgStatusMsg = (status) => {
  return `
    <div style="border: 5px solid #ccc; padding: 15px;">
      <h1 style="text-align: center;">Let's work | Kyiv: Organization Approval Status</h1>
      <p>${
        status === 'reject'
          ? "We're sorry to inform you that your organization registration has been rejected by our admin. If you're sure that the information you provided is correct, please register your organization to Job Seek again, then our admin will kindly review it and accept it."
