...
const Candidates = ({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>Let&apos;s work | Candidates</title>
      </Head>
      <Navbar />
      <div className="md:py-10 py-7 md:px-16 px-5">
        ...
        >
          ...
          />
          <button className="outline-0 bg-blue-400 hover:bg-blue-600 transition-[background] px-5 py-2 text-white text-sm rounded-full">
            Search
          </button>
        </form>
      </div>
