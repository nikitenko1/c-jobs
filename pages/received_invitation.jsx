...
import OrganizationCard from './../components/global/OrganizationCard';

const ReceivedInvitation = () => {
  const router = useRouter();
  const dispatch = useDispatch();
  const { auth, invitation } = useSelector((state) => state);
  ...
  return (
    <>
      <Head>
        <title>Let&apos;s work | Received Invitation</title>
      </Head>
      <Navbar />
